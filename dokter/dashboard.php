...
<body class="bg-gray-100">
    <div class="flex">
       ...
       value="<?php echo htmlspecialchars($doctor['nama'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" 
       class="border p-2 w-full mb-4">

<label class="block">Address:</label>
<input type="text" name="alamat" 
       value="<?php echo htmlspecialchars($doctor['alamat'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" 
       class="border p-2 w-full mb-4">

<label class="block">Phone Number:</label>
<input type="text" name="no_hp" 
       value="<?php echo htmlspecialchars($doctor['no_hp'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" 
       class="border p-2 w-full mb-4">
