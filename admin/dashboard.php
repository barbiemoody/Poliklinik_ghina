    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-blue-900 text-white min-h-screen">
            ...
            <nav class="mt-4">
                ...
                <a href="../public/logout.php" class="block py-2 px-4 hover:bg-blue-700">Logout</a>
            </nav>
        </aside>
                ...
                <table class="w-full mt-6 border">
                    ...
                    <tbody>
                        <?php while ($schedule = mysqli_fetch_assoc($schedules_result)) : ?>
                            <tr>
                            <td class="border px-4 py-2"><?php echo htmlspecialchars($schedule['id'] ?? 'N/A'); ?></td>
<td class="border px-4 py-2"><?php echo htmlspecialchars($schedule['doctor_id'] ?? 'N/A'); ?></td>
<td class="border px-4 py-2"><?php echo htmlspecialchars($schedule['schedule_date'] ?? 'N/A'); ?></td>
<td class="border px-4 py-2"><?php echo htmlspecialchars($schedule['schedule_time'] ?? 'N/A'); ?></td>
